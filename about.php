    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-content scroll-animate">
                ...
                <h2 class="cta-title">Ready to Begin Your Property Journey?</h2>
                <p class="cta-text">Whether you're buying, investing, or planning your next build, Owningottawa brings every service you need together in one place. Let's make your next move strategic, confident, and rewarding.</p>
                <div class="cta-buttons">
                    <a href="/contact" class="btn-modern-primary">
                        <span>Book a Consultation</span>
                        <i class="fas fa-calendar-check"></i>
                    </a>
                    <a href="/services" class="btn-modern-outline">
