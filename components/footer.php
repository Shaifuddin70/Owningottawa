...
<!-- Footer (built from lines 3–16 content) -->
<footer class="main-footer">
  <div class="footer-container">
    <div class="footer-section footer-brand">
      <h3 class="footer-heading">Owningottawa—Your Trusted Real Estate Partner</h3>
      <p>Helping first-time buyers, homeowners, and residential investors navigate Ottawa’s real estate market with clarity and confidence.</p>
      <p>
        <a href="tel:6133186478">📞 613-318-6478</a>
        &nbsp;&nbsp;
        <a href="mailto:info@owningottawa.ca">✉️ info@owningottawa.ca</a>
      </p>
  ...
  <div class="footer-bottom">
    <div class="footer-bottom-container">
      <div class="copyright">
        ...
        <p>© 2025 OwningOttawa—All rights reserved</p>
      </div>
    </div>
  </div>
</footer>
